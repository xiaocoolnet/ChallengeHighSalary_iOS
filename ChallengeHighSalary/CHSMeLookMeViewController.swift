...
class CHSMeLookMeViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func setSubviews() {
        ...
        rootTableView.registerNib(UINib.init(nibName: "CHSMeLookMeTableViewCell", bundle: nil), forCellReuseIdentifier: "CHSMeLookMeCell")
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCellWithIdentifier("CHSMeLookMeCell") as! CHSMeLookMeTableViewCell

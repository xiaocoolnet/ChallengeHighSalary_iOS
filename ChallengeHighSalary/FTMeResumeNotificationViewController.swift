...
class FTMeResumeNotificationViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func setSubviews() {
        ...
        rootTableView.register(UINib.init(nibName: "FTMeResumeNotificationTableViewCell", bundle: nil), forCellReuseIdentifier: "FTMeResumeNotificationCell")
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "FTMeResumeNotificationCell") as! FTMeResumeNotificationTableViewCell

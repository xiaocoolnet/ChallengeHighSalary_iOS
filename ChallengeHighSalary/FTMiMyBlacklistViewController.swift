...
class FTMiMyBlacklistViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func setSubviews() {
        ...
        rootTableView.registerNib(UINib.init(nibName: "FTMiMyBlacklistTableViewCell", bundle: nil), forCellReuseIdentifier: "FTMiMyBlacklistCell")
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCellWithIdentifier("FTMiMyBlacklistCell") as! FTMiMyBlacklistTableViewCell

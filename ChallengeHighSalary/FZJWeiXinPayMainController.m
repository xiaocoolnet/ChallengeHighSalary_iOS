...
//    NSString * price = @"3";//价格以分为单位
    ...
    [packageParams setObject: orderTitle    forKey:@"body"];        //订单描述，展示给用户
    NSString * str = [NSString stringWithFormat:@"%@",@"http://nyjob.xiaocool.net/api/returnwx/example/notify.php"];//[NSString stringWithFormat:@"%@",[payDic objectForKey:@"notify_url"]];
...
-(NSString *)timeStamp{
    return [NSString stringWithFormat:@"%@%ld%s",@"tzgx",(long)[[NSDate date] timeIntervalSince1970],"weixin"];
}

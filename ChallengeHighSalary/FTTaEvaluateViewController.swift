//
//  FTTaEvaluateViewController.swift
//  ChallengeHighSalary
//
...
class FTTaEvaluateViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        //        self.navigationController?.pushViewController(FTTaPersonalInfoViewController(), animated: true)
    }
    
    // MARK:- companyBtnClick
    func companyBtnClick() {
//        self.navigationController?.pushViewController(FTTaCompanyHomeViewController(), animated: true)
    }

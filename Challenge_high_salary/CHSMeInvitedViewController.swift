...
class CHSMeInvitedViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func setSubviews() {
        ...
        rootTableView.registerNib(UINib.init(nibName: "CHSMeInvitedTableViewCell", bundle: nil), forCellReuseIdentifier: "CHSMeInvitedCell")
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCellWithIdentifier("CHSMeInvitedCell") as! CHSMeInvitedTableViewCell
